...
import com.sanleng.mobilefighting.fragment.AlreadyRectificationFragment;
import com.sanleng.mobilefighting.fragment.StayRectificationFragment;
...
public class RectificationActivity extends FragmentActivity implements OnClickListener {
	...
	private void InitViewPager() {
		...
		fragments.add(new StayRectificationFragment());
		fragments.add(new AlreadyRectificationFragment());
