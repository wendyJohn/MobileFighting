...
import com.sanleng.mobilefighting.fragment.AlreadyInspectionPendingtaskFragment;
import com.sanleng.mobilefighting.fragment.NotInspectionPendingtaskFragment;
...
public class InspectionMissionActivity extends FragmentActivity implements OnClickListener {
	...
	private void InitViewPager() {
		...
		fragments.add(new NotInspectionPendingtaskFragment());
		fragments.add(new AlreadyInspectionPendingtaskFragment());
