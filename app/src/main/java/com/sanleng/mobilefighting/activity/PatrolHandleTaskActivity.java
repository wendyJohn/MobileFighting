 ...
 *
 */
public class PatrolHandleTaskActivity extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.patrolhandletaskactivity);
		initView();
	}
	...
	private void loadData(int page) {
		...
		params.put("unitcode", PreferenceUtils.getString(PatrolHandleTaskActivity.this, "unitcode"));
		params.put("username", PreferenceUtils.getString(PatrolHandleTaskActivity.this, "MobileFig_username"));
		params.put("platformkey", "app_firecontrol_owner");
		params.put("bind_taskid", taskId);
...
//				promptDialog.dismiss();
				try {
					...
					if (msg.equals("获取成功")) {
						...
						patrolRecordAdapter.bindData(PatrolHandleTaskActivity.this, allList);
						if (pageNo == 1) {
						...
						patrolrecordlslistview.setOnScrollListener(new OnScrollListener() {
							...
							public void onScrollStateChanged(AbsListView view, int scrollState) {
								...
								if (is_divPage && scrollState == OnScrollListener.SCROLL_STATE_IDLE && pageNo <= allpage
									...
									Toast.makeText(PatrolHandleTaskActivity.this, "加载完了！", Toast.LENGTH_SHORT).show();
								}
							}
