...
public class BuilderManager {
    ...
    private static int[] imageResources = new int[]{
            R.drawable.emergency_ica,
            R.drawable.emergency_icb,
            R.drawable.emergency_icc,
            R.drawable.emergency_icd,
            R.drawable.emergency_ice,
            R.drawable.emergency_icf,
            R.drawable.emergency_icg,
            R.drawable.emergency_ich,
            R.drawable.emergency_ici,
    };
