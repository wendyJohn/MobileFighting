...
import com.sanleng.mobilefighting.activity.MapFunctionActivity;
    ...
    private void initMap() {
        ...
        mBaiduMap.setOnMarkerClickListener(new OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker arg0) {
                ...
                type = bean.getType();
                if (type.equals("火警")) {
                    fireFormationDialog = new FireFormationDialog(getActivity(), clickListener,
                            AlarmEquipment, AlarmUnit, AlarmEquipment, AlarmTime);
                    fireFormationDialog.show();
                } else {
                    e_stationDialog = new E_StationDialog(getActivity(), clickListener,
                            AlarmEquipment, AlarmUnit, AlarmEquipment, null);
